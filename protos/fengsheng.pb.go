...
type NotifyPhaseToc struct {
	...
	IntelligencePlayerId uint32    `protobuf:"varint,3,opt,name=intelligence_player_id,json=intelligencePlayerId,proto3" json:"intelligence_player_id,omitempty"` // 情报在谁面前（只有传递、争夺、接收阶段有效）
	...
	LockPlayerIds        []uint32  `protobuf:"varint,6,rep,packed,name=lock_player_ids,json=lockPlayerIds,proto3" json:"lock_player_ids,omitempty"`               // 被锁定的玩家ID
	WaitingPlayerId      uint32    `protobuf:"varint,7,opt,name=waiting_player_id,json=waitingPlayerId,proto3" json:"waiting_player_id,omitempty"`                // 读秒的玩家ID
	WaitingSecond        uint32    `protobuf:"varint,8,opt,name=waiting_second,json=waitingSecond,proto3" json:"waiting_second,omitempty"`                        // 读多少秒
	Seq                  uint32    `protobuf:"varint,9,opt,name=seq,proto3" json:"seq,omitempty"`                                                                 // 只有当自己需要读秒时，这个字段才有值
}
...
func (x *NotifyPhaseToc) GetIntelligencePlayerId() uint32 {
	if x != nil {
		return x.IntelligencePlayerId
	}
	return 0
}
...
func (x *NotifyPhaseToc) GetLockPlayerIds() []uint32 {
	if x != nil {
...
type UsePingHengToc struct {
	...
	DiscardCards       []*Card `protobuf:"bytes,4,rep,name=discard_cards,json=discardCards,proto3" json:"discard_cards,omitempty"`                     // 使用者弃掉的牌。（平衡摸的三张牌直接发add_card_toc协议）
	TargetDiscardCards []*Card `protobuf:"bytes,5,rep,name=target_discard_cards,json=targetDiscardCards,proto3" json:"target_discard_cards,omitempty"` // 被使用者弃掉的牌。（平衡摸的三张牌直接发add_card_toc协议）
}
...
func (x *UsePingHengToc) GetDiscardCards() []*Card {
	if x != nil {
...
func (x *UsePingHengToc) GetTargetDiscardCards() []*Card {
	if x != nil {
		return x.TargetDiscardCards
	}
	return nil
}
...
type WeiBiShowHandCardToc struct {
	...
	PlayerId       uint32  `protobuf:"varint,2,opt,name=player_id,json=playerId,proto3" json:"player_id,omitempty"`
	TargetPlayerId uint32  `protobuf:"varint,3,opt,name=target_player_id,json=targetPlayerId,proto3" json:"target_player_id,omitempty"`
	Cards          []*Card `protobuf:"bytes,4,rep,name=cards,proto3" json:"cards,omitempty"` // 展示所有手牌，只有使用者能看到，其他人收到的都是空数组
}
...
type NotifyWinnerToc struct {
	...
	DeclarePlayerId uint32       `protobuf:"varint,1,opt,name=declare_player_id,json=declarePlayerId,proto3" json:"declare_player_id,omitempty"`
...
type NotifyDieGiveCardToc struct {
	...
	CardId         []*Card `protobuf:"bytes,3,rep,name=card_id,json=cardId,proto3" json:"card_id,omitempty"`                            // 不给就填空数组
}
...
func (x *NotifyDieGiveCardToc) GetCardId() []*Card {
	if x != nil {
		return x.CardId
	}
	return nil
...
var file_fengsheng_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xdd, 0x01, 0x0a, 0x04, 0x63, 0x61, 0x72, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x63, 0x61,
	...
	0x61, 0x77, 0x43, 0x61, 0x72, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x63, 0x61, 0x6e, 0x5f, 0x6c, 0x6f,
	0x63, 0x6b, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x63, 0x61, 0x6e, 0x4c, 0x6f, 0x63,
	0x6b, 0x22, 0x80, 0x01, 0x0a, 0x08, 0x69, 0x6e, 0x69, 0x74, 0x5f, 0x74, 0x6f, 0x63, 0x12, 0x21,
	...
	0x74, 0x12, 0x22, 0x0a, 0x08, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0
 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x6c, 0x61,
	0x79, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x70, 0x6c,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x19, 0x0a, 0x04, 0x63, 0x61, 0x72, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x05, 0x2e,
	0x63, 0x61, 0x72, 0x64, 0x52, 0x04, 0x63, 0x61, 0x72, 0x64, 0x22, 0x9a, 0x01, 0x0a, 0x19, 0x77,
	0x65, 0x69, 0x5f, 0x62, 0x69, 0x5f, 0x73, 0x68, 0x6f, 0x77, 0x5f, 0x68, 0x61, 0x6e, 0x64, 0x5f,
	0x63, 0x61, 0x72, 0x64, 0x5f, 0x74, 0x6f, 0x63, 0x12, 0x19, 0x0a, 0x04, 0x63, 0x61, 0x72, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x05, 0x2e, 0x63, 0x61, 0x72, 0x64, 0x52, 0x04, 0x63,
	...
	,
	...
	,
	...
	,
	...
	0x52, 0x08, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x49, 0x64, 0x12, 0x25, 0x0a, 0x0e, 0x77, 0x61,
	0x69, 0x74, 0x69, 0x6e, 0x67, 0x5f, 0x73, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x0d, 0x77, 0x61, 0x69, 0x74, 0x69, 0x6e, 0x67, 0x53, 0x65, 0x63, 0x6f, 0x6e,
	0x64, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x65, 0x71, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03,
	0x73, 0x65, 0x71, 0x22, 0x68, 0x0a, 0x11, 0x64, 0x69, 0x65, 0x5f, 0x67, 0x69, 0x76, 0x65, 0x5f,
	0x63, 0x61, 0x72, 0x64, 0x5f, 0x74, 0x6f, 0x73, 0x12, 0x28, 0x0a, 0x10, 0x74, 0x61, 0x72, 0x67,
	...
	,
	...
	,
	...
	,
	...
	0x6c, 0x61, 0x79, 0x65, 0x72, 0x49, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x65, 0x71, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x73, 0x65, 0x71, 0x22, 0x72, 0x0a, 0x0e, 0x75, 0x73, 0x65,
	0x5f, 0x77, 0x75, 0x5f, 0x64, 0x61, 0x6f, 0x5f, 0x74, 0x6f, 0x63, 0x12, 0x19, 0x0a, 0x04, 0x63,
	0x61, 0x72, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x05, 0x2e, 0x63, 0x61, 0x72, 0x64,
	0x52, 0x04, 0x63, 0x61, 0x72, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72,
	...
	,
...
var file_fengsheng_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_fengsheng_proto_goTypes = []interface{}{
	...
	(*Card)(nil),                    // 5: card
	(*InitToc)(nil),                 // 6: init_toc
	(*AddCardToc)(nil),              // 7: add_card_toc
	(*UseShiTanTos)(nil),            // 8: use_shi_tan_tos
	(*UseShiTanToc)(nil),            // 9: use_shi_tan_toc
	(*ShowShiTanToc)(nil),           // 10: show_shi_tan_toc
	(*ExecuteShiTanTos)(nil),        // 11: execute_shi_tan_tos
	(*ExecuteShiTanToc)(nil),        // 12: execute_shi_tan_toc
	(*SyncDeckNumToc)(nil),          // 13: sync_deck_num_toc
	(*DiscardCardToc)(nil),          // 14: discard_card_toc
	(*NotifyPhaseToc)(nil),          // 15: notify_phase_toc
	(*EndMainPhaseTos)(nil),         // 16: end_main_phase_tos
	(*UseLiYouTos)(nil),             // 17: use_li_you_tos
	(*UseLiYouToc)(nil),             // 18: use_li_you_toc
	(*UsePingHengTos)(nil),          // 19: use_ping_heng_tos
	(*UsePingHengToc)(nil),          // 20: use_ping_heng_toc
	(*UseWeiBiTos)(nil),             // 21: use_wei_bi_tos
	(*WeiBiWaitForGiveCardToc)(nil), // 22: wei_bi_wait_for_give_card_toc
	(*WeiBiGiveCardTos)(nil),        // 23: wei_bi_give_card_tos
	(*WeiBiGiveCardToc)(nil),        // 24: wei_bi_give_card_toc
	...
	(*EndFightPhaseTos)(nil),        // 30: end_fight_phase_tos
	(*NotifyDieToc)(nil),            // 31: notify_die_toc
	(*NotifyWinnerToc)(nil),         // 32: notify_winner_toc
	(*WaitForChengQingToc)(nil),     // 33: wait_for_cheng_qing_toc
	(*ChengQingSaveDieTos)(nil),     // 34: cheng_qing_save_die_tos
	(*WaitForDieGiveCardToc)(nil),   // 35: wait_for_die_give_card_toc
	(*DieGiveCardTos)(nil),          // 36: die_give_card_tos
	(*NotifyDieGiveCardToc)(nil),    // 37: notify_die_give_card_toc
	(*UsePoYiTos)(nil),              // 38: use_po_yi_tos
	(*UsePoYiToc)(nil),              // 39: use_po_yi_toc
	(*PoYiShowTos)(nil),             // 40: po_yi_show_tos
	(*PoYiShowToc)(nil),             // 41: po_yi_show_toc
	(*UseJieHuoTos)(nil),            // 42: use_jie_huo_tos
	(*UseJieHuoToc)(nil),            // 43: use_jie_huo_toc
	(*UseDiaoBaoTos)(nil),           // 44: use_diao_bao_tos
	(*UseDiaoBaoToc)(nil),           // 45: use_diao_bao_toc
	(*UseWuDaoTos)(nil),             // 46: use_wu_dao_tos
	(*UseWuDaoToc)(nil),             // 47: use_wu_dao_toc
}
var file_fengsheng_proto_depIdxs = []int32{
	...
	5,  // 6: add_card_toc.cards:type_name -> card
	5,  // 7: show_shi_tan_toc.card:type_name -> card
	5,  // 8: discard_card_toc.cards:type_name -> card
	0,  // 9: notify_phase_toc.current_phase:type_name -> phase
	4,  // 10: notify_phase_toc.message_card_dir:type_name -> direction
	5,  // 11: notify_phase_toc.message_card:type_name -> card
	5,  // 12: use_li_you_toc.li_you_card:type_name -> card
	5,  // 13: use_li_you_toc.message_card:type_name -> card
	5,  // 14: use_ping_heng_toc.ping_heng_card:type_name -> card
	5,  // 15: use_ping_heng_toc.discard_cards:type_name -> card
	5,  // 16: use_ping_heng_toc.target_discard_cards:type_name -> card
	1,  // 17: use_wei_bi_tos.want_type:type_name -> card_type
	5,  // 18: wei_bi_wait_for_give_card_toc.card:type_name -> card
	1,  // 19: wei_bi_wait_for_give_card_toc.want_type:type_name -> card_type
	5,  // 20: wei_bi_give_card_toc.card:type_name -> card
	...
	5,  // 27: notify_die_give_card_toc.card_id:type_name -> card
	5,  // 28: use_po_yi_toc.card:type_name -> card
	5,  // 29: use_po_yi_toc.message_card:type_name -> card
	5,  // 30: po_yi_show_toc.message_card:type_name -> card
	5,  // 31: use_jie_huo_toc.card:type_name -> card
	5,  // 32: use_diao_bao_toc.old_message_card:type_name -> card
	5,  // 33: use_wu_dao_toc.card:type_name -> card
