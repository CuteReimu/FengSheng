...
type NotifyPhaseToc struct {
	...
	CardDir              Direction `protobuf:"varint,4,opt,name=card_dir,json=cardDir,proto3,enum=Direction" json:"card_dir,omitempty"`                           // 情报传递方向（只有传递、争夺、接收阶段有效）
	Card                 *Card     `protobuf:"bytes,5,opt,name=card,proto3" json:"card,omitempty"`                                                                // 在某些情况下，正在传递的情报应该正面向上，这时候就应该有这个字段
...
func (x *NotifyPhaseToc) GetCardDir() Direction {
	if x != nil {
		return x.CardDir
	}
	return Direction_Up
...
func (x *NotifyPhaseToc) GetCard() *Card {
	if x != nil {
		return x.Card
	}
	return nil
...
var file_fengsheng_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x73, 0x22, 0xc8, 0x02, 0x0a, 0x10, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x5f, 0x70,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x07, 0x63, 0x61, 0x72, 0x64, 0x44, 0x69, 0x72, 0x12, 0x19,
	0x0a, 0x04, 0x63, 0x61, 0x72, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x05, 0x2e, 0x63,
	0x61, 0x72, 0x64, 0x52, 0x04, 0x63, 0x61, 0x72, 0x64, 0x12, 0x2a, 0x0a, 0x11, 0x77, 0x61, 0x69,
	...
	0x61, 0x72, 0x64, 0x49, 0x64, 0x22, 0x6c, 0x0a, 0x15, 0x73, 0x65, 0x6e, 0x64, 0x5f, 0x6d, 0x65,
	...
	0x73, 0x65, 0x71, 0x22, 0x48, 0x0a, 0x1a, 0x63, 0x68, 0x6f, 0x6f, 0x73, 0x65, 0x5f, 0x77, 0x68,
	0x65, 0x74, 0x68, 0x65, 0x72, 0x5f, 0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x5f, 0x74, 0x6f,
	0x73, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x07, 0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x73,
	0x65, 0x71, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x73, 0x65, 0x71, 0x2a, 0x5b, 0x0a,
	...
	0x68, 0x61, 0x73, 0x65, 0x10, 0x01, 0x12, 0x0e, 0x0a, 0x0a, 0x53, 0x65, 0x6e, 0x64, 0x5f, 0x50,
	0x68, 0x61, 0x73, 0x65, 0x10, 0x02, 0x12, 0x0f, 0x0a, 0x0b, 0x46, 0x69, 0x67, 0x68, 0x74, 0x5f,
	0x50, 0x68, 0x61, 0x73, 0x65, 0x10, 0x03, 0x12, 0x11, 0x0a, 0x0d, 0x52, 0x65, 0x63, 0x65, 0x69,
	0x76, 0x65, 0x5f, 0x50, 0x68, 0x61, 0x73, 0x65, 0x10, 0x04, 0x2a, 0x81, 0x01, 0x0a, 0x09, 0x63,
...
var file_fengsheng_proto_depIdxs = []int32{
	...
	4,  // 10: notify_phase_toc.card_dir:type_name -> direction
	5,  // 11: notify_phase_toc.card:type_name -> card
