...
type UseLiYouToc struct {
	...
	PlayerId       uint32 `protobuf:"varint,1,opt,name=player_id,json=playerId,proto3" json:"player_id,omitempty"`                     // 使用者
	TargetPlayerId uint32 `protobuf:"varint,2,opt,name=target_player_id,json=targetPlayerId,proto3" json:"target_player_id,omitempty"` // 被使用者
	Card           *Card  `protobuf:"bytes,3,opt,name=card,proto3" json:"card,omitempty"`                                              // 利诱翻出来的牌。如果牌堆和弃牌堆全用完了，则为null/nil
	JoinIntoHand   bool   `protobuf:"varint,4,opt,name=join_into_hand,json=joinIntoHand,proto3" json:"join_into_hand,omitempty"`       // 是否改为加入使用者手牌
}
...
func (x *UseLiYouToc) GetCard() *Card {
	if x != nil {
		return x.Card
	}
	return nil
...
var file_fengsheng_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x71, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x73, 0x65, 0x71, 0x22, 0x98,
	...
	,
...
var file_fengsheng_proto_depIdxs = []int32{
	...
	5,  // 10: use_li_you_toc.card:type_name -> card
